...
let coisas: (number | string)[] = [10, 20, 30, 'teste'];
...
let coisas2: [string, number] = ['corda', 10];          // Precisa seguir exatamente como foi declarado, pois se colocassemos ['corda', 10, 10] iríamos ter erro. 
...
let coisas3: readonly[string, number] = ['corda', 10];         
