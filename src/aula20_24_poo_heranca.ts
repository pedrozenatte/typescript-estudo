...
class Teste extends ContaBancaria {
    // Essa classe herda TUDO de ContaBancaria e não precisa necessariamente de um construtor, pois vai ser utilizado o construtor da super classe. 
}
// ----------------------------------------------------------------------------------------
